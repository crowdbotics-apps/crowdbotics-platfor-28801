...
## Project Structure
    ...
    ├── crowdbotics_platfor_28801  # Django project configurations
...
1. Clone this repo and `cd crowdbotics_platfor_28801`
...
2. Clone this repo and `cd crowdbotics_platfor_28801`
